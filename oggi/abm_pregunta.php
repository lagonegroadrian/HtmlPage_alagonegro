        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <form action="funk/validar_trivia.php?q=ask" method="POST" enctype="multipart/form-data">
              <h3 class="w3-opacity">Alta de Pregunta</h3>
...
<?php
              for ($aux=0; $aux < count($triviaOK); $aux++) 
              { 
              $_id_tr=$triviaOK[$aux]['id_tr'];
              $_texto_tr=$triviaOK[$aux]['texto_tr'];
              echo "<option value='".$_id_tr."'>".$_texto_tr."</option>";
              }
?>
              </select> <br> <br>

              <input type="text" name="ask" placeholder="ingresar Pregunta" class="w3-border w3-padding" required><br> <br>
