<?php
		class Conexion{
			...
			function Conexion(){
				$this->ruta       ="localhost"; //
				$this->usuario    ="c1701367"; //usuario que tengas definido
				$this->contrasena ="bu97BUnuzi"; //contraseña que tengas definidad
				$this->baseDatos  ="c1701367_oggi"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
