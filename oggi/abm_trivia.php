        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <form action="funk/validar_trivia.php?q=tri" method="POST" enctype="multipart/form-data">
              <h3 class="w3-opacity">Alta de Trivia</h3>
              
              <!--p contenteditable="true" class="w3-border w3-padding">Status: Feeling Blue</p-->

              <input type="text" name="titulo" placeholder="Titulo Trivia" class="w3-border w3-padding" required>              <br> <br>
              <input type="date" name="fechainicio" placeholder="fecha inicio" class="w3-border w3-padding" required>              <br> <br>
              <input type="date" name="fechafin" placeholder="fecha fin" class="w3-border w3-padding" required>              <br> <br>

              <!-- imagen 1 -->
              <div class="form-group">
              <input type="file" class="w3-button w3-theme" name="imag1" id="imag1" aria-describedby="fileHelpId"><br>
              <small id="fileHelpId" class="form-text text-muted">El formato de la imagen debe ser <b>PDF</b></small>
              </div><br>

              <label for="perfil"><b>Quienes lo pueden hacer </b></label><br>
...
<?php
              for ($aux=0; $aux < count($perfilOK); $aux++)
              {
                ...
                echo "<input type='checkbox' name='perfil[]' value='".$perfilOK[$aux]['id_pe']."' $_chec > ".ucfirst($perfilOK[$aux]['txt_pe']) ."<br>";
              }
?>
              <br>
