...
$url="http://servicios.gestos.com.ar:8080/ords/rws/gestos/viasano/consultarAfiliado/".$numero;
	...
	{	
		if($estado !== 'Activo'){$mensaje = "El DNI: ".$numero." Pertenece a :".$nombre_apellido."<br> "."Afiliado :".$estado."<br>";}
		else
		{
		$mensaje = "El DNI: ".$numero." Pertenece a :".$nombre_apellido."<br> "."Afiliado :".$estado."<br>".
		"Esta persona tiene credencial? ".$tiene_credencial."<br>".
		"Es PMI : ".$pmi."<br>".
		"Posee alguna incapacidad? : ".$incapacidad."<br>".
		"Plan :".$categoria;
...
<div id="consultardni">
<h2>Donde se puede atender el paciente?</h2>
