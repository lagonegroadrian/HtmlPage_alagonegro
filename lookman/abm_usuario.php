...
if(isset($_GET['trae']))
{
	...
	if ($_GET['trae'] == 1)
		...
		$usuariosOK = $usuarios->getUsuarios();
...
<div class="banner-top">
	<div class="container">
		<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">Usuarios</h2>
	...
	<div class="login">
		<div class="container">
			...
			<div class="col-md-6 login-do animated wow fadeInRight" data-wow-delay=".5s">
					<a href="registro.php" class="hvr-sweep-to-top">Crear Usuario</a>
			</div>
...
<?php
	for ($aux1=0; $aux1 < count($usuariosOK); $aux1++) 
	{
		echo "<tr>";			
			echo "<td>".$usuariosOK[$aux1]['usuario_nombre']."</td>";
			echo "<td>".$usuariosOK[$aux1]['perfil']."</td>";
...
?>
			...
			<form action="registro.php" method="POST">
				...
				<?php			echo "value='".$usuariosOK[$aux1]['id_usuario']."'"; ?> >
