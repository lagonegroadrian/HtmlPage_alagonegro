...
<!-- //js -->
<!-- cart -->
<script src="../jssimpleCart.min.js"></script>
<!-- cart -->
<!-- for bootstrap working -->
<script type="text/javascript" src="../jsbootstrap-3.1.1.min.js"></script>
<!-- //for bootstrap working -->
<!-- animation-effect -->
<link href="../css/animate.min.css" rel="stylesheet"> 
<script src="../jswow.min.js"></script>
<script>
 new WOW().init();
</script>
<!-- //animation-effect -->
					...
					<div class="navbar-header nav_2">
						<button type="button" class="navbar-toggle collapsed navbar-toggle1" data-toggle="collapse" data-target="#bs-megadropdown-tabs">
						 ...
						 <div class="navbar-brand logo-nav-left wow fadeInLeft animated" data-wow-delay=".5s">
							<h1 class="animated wow pulse" data-wow-delay=".5s"><a href="../index.php">Classic<span>Style</span></a></h1>
						</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												...
												<li><a href="products1.php">Accessories</a></li>
												<li><a href="products1.php">Bags</a></li>
												<li><a href="products1.php">Caps & Hats</a></li>
												<li><a href="products1.php">Hoodies & Sweatshirts</a></li>
										...
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Submenu2</h6>
												<li><a href="products1.php">Jackets & Coats</a></li>
												<li><a href="products1.php">Jeans</a></li>
												<li><a href="products1.php">Jewellery</a></li>
												<li><a href="products1.php">Jumpers & Cardigans</a></li>
												<li><a href="products1.php">Leather Jackets</a></li>
												<li><a href="products1.php">Long Sleeve T-Shirts</a></li>
										...
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Submenu3</h6>
												<li><a href="products1.php">Shirts</a></li>
												<li><a href="products1.php">Shoes, Boots & Trainers</a></li>
												<li><a href="products1.php">Sunglasses</a></li>
												<li><a href="products1.php">Sweatpants</a></li>
												<li><a href="products1.php">Swimwear</a></li>
