...
<div class="banner-top">
	<div class="container">
		<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">Contácto</h2>
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="../index.php">Home</a><label>/</label>Contácto</h3>
